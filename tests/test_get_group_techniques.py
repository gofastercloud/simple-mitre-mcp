...
def _format_group_techniques_response(group: dict, technique_details: list, data: dict) -> str:
    """
...
class TestGetGroupTechniques:
    ...
    def test_format_group_techniques_response_success(self):
        ...
        technique_details = _get_technique_details(group['techniques'], self.sample_data)
        response = _format_group_techniques_response(group, technique_details, self.sample_data)
    ...
    def test_format_group_techniques_response_missing_tactic_names(self):
        ...
        response = _format_group_techniques_response(group, technique_details, modified_data)
