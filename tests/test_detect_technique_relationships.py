...
class TestDetectTechniqueRelationships:
    ...
    def mock_data_loader(self):
        ...
        mock_loader.config = {
            "data_sources": {"mitre_attack": {"url": "https://example.com/test.json"}}
        }
    ...
    async def test_detect_technique_relationships_specific_types(self, mcp_server):
        ...
        result, _ = await mcp_server.call_tool(
            ...
            {"technique_id": "T1055", "relationship_types": ["uses", "subtechnique-o"]},
        )
    ...
    async def test_detect_technique_relationships_custom_depth(self, mcp_server):
        ...
        result, _ = await mcp_server.call_tool(
            "detect_technique_relationships", {"technique_id": "T1055", "depth": 3}
        )
    ...
    async def test_detect_technique_relationships_depth_limits(self, mcp_server):
        ...
        result, _ = await mcp_server.call_tool(
            "detect_technique_relationships", {"technique_id": "T1055", "depth": 10}
        )
    ...
    @pytest.mark.asyncio
    async def test_detect_technique_relationships_subtechnique_hierarchy(
        self, mcp_server
    ):
        ...
        result, _ = await mcp_server.call_tool(
            "detect_technique_relationships",
            {"technique_id": "T1055", "relationship_types": ["subtechnique-o"]},
        )
    ...
    async def test_detect_technique_relationships_attribution(self, mcp_server):
        ...
        result, _ = await mcp_server.call_tool(
            "detect_technique_relationships",
            {"technique_id": "T1055", "relationship_types": ["uses"]},
        )
    ...
    async def test_detect_technique_relationships_detection(self, mcp_server):
        ...
        result, _ = await mcp_server.call_tool(
            "detect_technique_relationships",
            {"technique_id": "T1055", "relationship_types": ["detects"]},
        )
    ...
    @pytest.mark.asyncio
    async def test_detect_technique_relationships_invalid_relationship_types(
        self, mcp_server
    ):
    ...
    async def test_detect_technique_relationships_case_insensitive(self, mcp_server):
        ...
        content = result[0].text
        assert (
            "T1055 - Process Injection" in content
    ...
    async def test_detect_technique_relationships_mixed_types(self, mcp_server):
        ...
        assert "TECHNIQUE RELATIONSHIP ANALYSIS" in content
        assert (
            "Relationship Types: uses, mitigates" in content
    ...
    async def test_detect_technique_relationships_all_types(self, mcp_server):
        ...
        assert "TECHNIQUE RELATIONSHIP ANALYSIS" in content
        assert (
            "detects, subtechnique-o, attributed-to, uses, mitigates, revoked-by"
            in content
        )
