...
class TestMitreIdExtractionEnhancement:
    ...
    def test_extract_mitre_id_multiple_mitre_references(self):
        ...
        technique = stix2.AttackPattern(
            ...
            external_references=[
                ...
                stix2.ExternalReference(
                    source_name="mitre-attack", external_id="T5678"
                ),
            ],
        )
    ...
    def test_extract_mitre_id_no_mitre_references(self):
        ...
        technique = stix2.AttackPattern(
            ...
            external_references=[
                ...
                stix2.ExternalReference(
                    source_name="another-source", external_id="ANOTHER-456"
                ),
            ],
        )
    ...
    def test_extract_mitre_id_empty_external_references(self):
        ...
        technique = stix2.AttackPattern(name="Test Technique", external_references=[])
    ...
    def test_extract_mitre_id_missing_external_references(self):
        ...
        stix_dict = {"type": "attack-pattern", "name": "Test Technique"}
    ...
    def test_validate_mitre_id_format_invalid_ids(self):
        ...
        assert (
            self.parser._validate_mitre_id_format("T1234.01") == False
        )  # Sub-technique too short
        assert (
            self.parser._validate_mitre_id_format("T1234.0001") == False
        )  # Sub-technique too long
        ...
        assert (
            self.parser._validate_mitre_id_format("T1234.abc") == False
        )  # Non-numeric sub-technique
    ...
    def test_extract_mitre_id_invalid_format_rejected(self):
        ...
        stix_dict = {
            ...
            "name": "Test Technique",
            "external_references": [
                {"source_name": "mitre-attack", "external_id": "INVALID-ID"},
                {"source_name": "mitre-attack", "external_id": "T1234"},
            ],
        }
    ...
    def test_extract_mitre_id_stix_error_handling(self):
        ...
        with patch("builtins.hasattr", return_value=True):
            ...
            type(mock_stix_obj).external_references = property(
                lambda self: raise_stix_error()
            )
    ...
    def test_extract_mitre_id_case_sensitivity(self):
        ...
        stix_dict = {
            ...
            "name": "Test Technique",
            "external_references": [
                {"source_name": "MITRE-ATTACK", "external_id": "T1234"},  # Wrong case
                {"source_name": "mitre-attack", "external_id": "T5678"},  # Correct case
            ],
        }
