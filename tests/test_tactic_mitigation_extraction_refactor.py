...
class TestTacticMitigationExtractionRefactor:
    ...
    def test_tactic_extraction_fallback_on_stix2_error(self):
        ...
        with (
            ...
            patch("src.parsers.stix_parser.logger") as mock_logger,
        ):
    ...
    def test_stix2_library_object_type_validation(self):
        ...
        mitigation_result = self.parser._extract_mitigation_data_from_stix_object(
            mitigation_obj
        )
    ...
    def test_backward_compatibility_with_existing_tests(self):
        ...
        assert mitigation_result == {
            "techniques": []
        }  # Mitigations have techniques list
