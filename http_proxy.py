...
class HTTPProxy:
    ...
    async def serve_web_interface(self, request: web_request.Request) -> Response:
        ...
        try:
            ...
            return web.Response(text=f"Error loading web interface: {str(e)}", status=500)
            ...
            tools = [
                ...
                },
                {
                    ...
                    "inputSchema": {
                        "type": "object",
                        "properties": {
                            "start_tactic": {"type": "string", "description": "Starting tactic ID (e.g., TA0001)"},
                            "end_tactic": {"type": "string", "description": "Target tactic ID (e.g., TA0040)"},
                            "group_id": {"type": "string", "description": "Optional: Filter by specific threat group"},
                            "platform": {"type": "string", "description": "Optional: Filter by platform (Windows, Linux, macOS)"}
                        },
                ...
                },
                {
                    ...
                    "inputSchema": {
                        "type": "object",
                        "properties": {
                            "threat_groups": {"type": "array", "items": {"type": "string"}, "description": "Array of threat group IDs"},
                            "technique_list": {"type": "array", "items": {"type": "string"}, "description": "Optional: Array of specific techniques to analyze"},
                            "exclude_mitigations": {"type": "array", "items": {"type": "string"}, "description": "Optional: Array of implemented mitigation IDs to exclude"}
                        },
                ...
                },
                {
                    ...
                    "inputSchema": {
                        "type": "object",
                        "properties": {
                            "technique_id": {"type": "string", "description": "Primary technique to analyze"},
                            "relationship_types": {"type": "array", "items": {"type": "string"}, "description": "Optional: Array of relationship types to include"},
                            "depth": {"type": "integer", "minimum": 1, "maximum": 3, "description": "Optional: Relationship traversal depth (default: 2, max: 3)"}
                        },
                        "required": ["technique_id"]
                    }
                }
...
async def create_http_proxy_server(host: str = "localhost", port: int = 8000):
    ...
    try:
        ...
        logger.info(f"Loaded {sum(len(entities) for entities in mitre_data.values())} entities")
